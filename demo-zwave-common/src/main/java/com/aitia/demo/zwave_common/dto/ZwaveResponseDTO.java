...
public class ZwaveResponseDTO implements Serializable {
	...
	//-------------------------------------------------------------------------------------------------
	public ZwaveResponseDTO() {}
	
	//-------------------------------------------------------------------------------------------------
	public ZwaveResponseDTO(final double value, final String serviceType, final String deviceType) {
		this.value = value;
